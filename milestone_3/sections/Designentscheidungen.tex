...
Sie verankert Datenpunkte räumlich und erlaubt Nutzer:innen, sofort einen Bezug zur eigenen Umgebung herzustellen.
...
Auf der Karte sind 58 Pins in fünf Farben eingeteilt: Orange (Kultur), Blau (Verkehr), Grün (Umwelt),
...
Kartenebene übertragen -- Kategorisierung geschieht passiv und automatisch durch die visuelle Wahrnehmung.
...
Die Suchfunktion ist als ausfahrbares Bottom-Sheet unterhalb der Karte realisiert -- nicht als eigener Screen mit
Navigation und Zurück-Button.
Im zugeklappten Zustand ist das Suchfeld dauerhaft sichtbar; beim Tippen fährt das Sheet auf und zeigt
frühere Suchanfragen oder Vorschläge.

Der Kernvorteil dieses Ansatzes liegt in der \textit{kontinuierlichen Kontextwahrnehmung}:
...
Manche beginnen explorativ auf der Karte und wollen dann mehr über einen Datensatz erfahren;
andere beginnen im Downloads-Screen und wollen einen bestimmten Ort auf der Karte verorten.
...
Jeder Datensatz zeigt nur Name, Beschreibung, Größe und Downloadstatus -- die Hauptinformation.
...
Das Löschen eines heruntergeladenen Datensatzes erfordert eine bewusste Wischbewegung und dann einen zusätzlichen Tap --
nicht-intendierte Löschvorgänge werden dadurch vermieden.
